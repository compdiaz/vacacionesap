		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Solicitud de Vacaciones y Asuntos Particulares",
									"targetURL": "#vacacionesap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vacacionesap-display": {
								"semanticObject": "vacacionesap",
								"action": "display",
								"description": "Solicitudes de periodos vacacionales o días de asuntos particulares dentro del entorno Aino@",
								"title": "Solicitud de Vacaciones y Asuntos Particulares",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vacacionesap",
									"url": sap.ui.require.toUrl("vacacionesap")
								}
							}
						}
					}
